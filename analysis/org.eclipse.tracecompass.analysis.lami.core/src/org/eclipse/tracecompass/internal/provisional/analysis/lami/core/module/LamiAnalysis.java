...
public class LamiAnalysis implements IOnDemandAnalysis {
    ...
    /** Log message for results output line being received */
    private static final String RECEIVED_RESULTS_MESSAGE = "Received results:"; //$NON-NLS-1$
    ...
    protected String getResultsFromCommand(List<String> command, IProgressMonitor monitor)
        ...
        try {
            ...
            try (BufferedReader in = new BufferedReader(new InputStreamReader(p.getInputStream()));) {
                ...
                while (line != null) {
                    Activator.instance().logInfo(RECEIVED_RESULTS_MESSAGE + ' ' + line);
                    /*
