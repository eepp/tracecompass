...
public class LamiAnalysisStub extends LamiAnalysis {
    ...
    @Override
    protected @NonNull Multimap<@NonNull String, @NonNull LamiChartModel> getPredefinedViews() {
        return ImmutableMultimap.of();
    }

    @Override
    public boolean appliesTo(@NonNull ITmfTrace trace) {
        return true;
    }
