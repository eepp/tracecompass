...
public class LamiJsonParserTest {
    ...
    public void testMetadata() {
        ...
        assertTrue(analysis.canRun(fTrace));
    ...
    public void testResults() throws OnDemandAnalysisException {
        ...
        assertEquals(2398123.0, aspects.get(1).resolveDouble(readEntry), 0.001);
        assertEquals(8123982.0, aspects.get(2).resolveDouble(readEntry), 0.001);
        assertEquals(223232.0, aspects.get(3).resolveDouble(readEntry), 0.001);
        assertEquals(98233.0, aspects.get(4).resolveDouble(readEntry), 0.001);
        assertEquals(1293828.0, aspects.get(5).resolveDouble(readEntry), 0.001);
        assertEquals(1195595.0, aspects.get(6).resolveDouble(readEntry), 0.001);
