...
public class LamiBarChartViewer extends LamiXYChartViewer {
    ...
    public LamiBarChartViewer(Composite parent, LamiResultTable resultTable, LamiChartModel chartModel) {
        ...
        /* Add mouse listener */
        getChart().getPlotArea().addListener(SWT.MouseDown, new LamiBarChartMouseDownListener());
    ...
    private final class LamiBarChartMouseDownListener implements Listener {
        @Override
        public void handleEvent(@Nullable Event event) {
            ...
            if (event != null) {
                 ...
                 * categories, and find the category index under the mouse.
                 *
                 * Since categories map directly to the index of the
                 * fResultTable and that this table is immutable the index of
                 * the entry corresponds to the categories index. Signal to all
                 * LamiViewer and LamiView the update of selection.
                 */
        ...
        public void paintControl(@Nullable PaintEvent e) {
            ...
            for (ISeries series : getChart().getSeriesSet().getSeries()) {
                ...
                for (int index : getSelection()) {
                    ...
                    Rectangle rectangle = ((IBarSeries) series).getBounds()[graphIndex];
