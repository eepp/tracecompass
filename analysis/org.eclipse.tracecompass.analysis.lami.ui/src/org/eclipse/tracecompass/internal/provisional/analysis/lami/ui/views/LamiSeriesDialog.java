...
import org.eclipse.tracecompass.internal.provisional.analysis.lami.core.module.LamiXYSeries;
...
public class LamiSeriesDialog extends SelectionDialog {
    ...
    private final List<LamiXYSeries> series;
    ...
    protected Control createDialogArea(@Nullable Composite parent) {
        ...
        button1.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(@Nullable SelectionEvent e) {
                ...
                if (x == null || ySelections.length == 0) {
                    return;
                }

                /* Add selection to series if it doesn not already exist in the list */
                for (Object y : ySelections) {
                    LamiXYSeries serie = new LamiXYSeries((LamiTableEntryAspect) x, ((LamiTableEntryAspect) y));
                ...
                /* Simply take the first one since all series should comply to the same restriction */
                fXCheckBoxOptions.forEach(checkBox -> {
            ...
            public void widgetSelected(@Nullable SelectionEvent e) {
                ...
                if (e != null && e.detail == SWT.CHECK) {
                    ...
                    if (selections.getFirstElement() != null) {
                        ...
                        /* If just selected look for stuff to disable.
                         * If not no need to look for stuff to disable since it
    ...
    private static <T extends Comparable<T>> TableViewerColumn createTableViewerColumn(TableViewer viewer, String name,
            Function<LamiXYSeries, T> propertyFunction) {
        ...
        viewerColumn.setLabelProvider(new ColumnLabelProvider() {
            ...
            public @Nullable String getText(@Nullable Object element) {
                if (element != null){
                    return propertyFunction.apply((LamiXYSeries) element).toString();
                }
                return null;
            }
        });
