...
package org.eclipse.tracecompass.internal.analysis.realtime.ui;
...
import org.eclipse.tracecompass.internal.analysis.realtime.ui.periods.marker.PeriodMarkerFactory;
...
public class Activator extends AbstractUIPlugin {
     ...
     *  The plug-in ID
     */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.analysis.realtime.ui"; //$NON-NLS-1$

    private final PeriodMarkerFactory fPeriodMarkerFactory = new PeriodMarkerFactory();
    ...
    public void start(BundleContext context) throws Exception {
        ...
        TmfTraceAdapterManager.registerFactory(fPeriodMarkerFactory, ITmfTrace.class);
    }

    @Override
    public void stop(BundleContext context) throws Exception {
        TmfTraceAdapterManager.unregisterFactory(fPeriodMarkerFactory);
