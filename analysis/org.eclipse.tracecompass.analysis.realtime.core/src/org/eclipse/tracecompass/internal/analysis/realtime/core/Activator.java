...
package org.eclipse.tracecompass.internal.analysis.realtime.core;
...
public class Activator extends TraceCompassActivator {
    ...
    private static final String PLUGIN_ID = "org.eclipse.tracecompass.analysis.realtime.core"; //$NON-NLS-1$
