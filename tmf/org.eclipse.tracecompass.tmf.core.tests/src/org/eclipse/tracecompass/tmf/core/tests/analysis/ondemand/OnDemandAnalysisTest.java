...
public class OnDemandAnalysisTest {
    ...
    private ITmfTrace traceThatApplies;
    private ITmfTrace traceThatDoesntApply;
    ...
    @Before
    public void setup() {
        traceThatApplies = new TmfTraceStub2();
        traceThatDoesntApply = new TmfTraceStub3();
    }
    ...
    public void teardown() {
        if (traceThatApplies != null) {
            traceThatApplies.dispose();
            traceThatApplies = null;
        }
        if (traceThatDoesntApply != null) {
            traceThatDoesntApply.dispose();
            traceThatDoesntApply = null;
        }
    }
    ...
    public void testApplies() {
        ITmfTrace trace = traceThatApplies;
        assertNotNull(trace);
    ...
    public void testDoesNotApply() {
        ITmfTrace trace = traceThatDoesntApply;
        assertNotNull(trace);
    ...
    public void testGetAnalysisFromTrace() {
        ...
        /* Make sure we produce a new set every time */
